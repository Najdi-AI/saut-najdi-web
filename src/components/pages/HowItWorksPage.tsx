...
const t = {
  ar: {
    ...
    intro:
      "أسهل طريقة تفهم فيها المنصة إنك تمشي مع مكالمة وحدة من البداية للنهاية. هذا بالضبط وش يصير من لحظة ما يدق عميلك، إلى أن تلقى كل شي مسجل ومكتوب وملخص في لوحتك.",
    cta: "احجز عرضاً",
    steps: [
      {
      ...
      },
      {
        ...
        body: "وهو يتكلم، كلام عميلك يتحول إلى نص لحظة بلحظة. والنظام مبني على اللهجات السعودية من أساسه: يفهم «أبغى أحجز بكره» و«وش أسعاركم» زي ما ينقالون فعلاً — مو نسخة كتب فصحى.",
      },
      {
      ...
      },
      {
        ...
        body: "الرد يطلع صوتاً طبيعياً وبنفس اللهجة. وإذا قاطعه العميل بنص الجملة — زي ما نسوي كلنا — الوكيل يسكت على طول ويسمع. وإذا قال له رقم حجز، يقرأه رقم رقم عشان يقدر يكتبه.",
      },
      {
        title: "ينفذ — مو بس يتكلم",
        body: "الوكيل يقدر يسوي أشياء حقيقية أثناء المكالمة: يتأكد من المواعيد الفاضية ويحجز، يسجل تفاصيل الطلب، يحفظ تفضيلات العميل عشان المرة الجاية، وإذا كان الدوام مقفل يسجل طلب اتصال ويوعد العميل إن أحد يرجع له.",
      },
      {
