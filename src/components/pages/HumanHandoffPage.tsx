  ...
  ar: {
    ...
    pillars: {
      ...
      items: [
        ...
        },
        {
          ...
          body: "من لوحة التحكم، فريقك يتابع المكالمات وهي صايرة: يسمع مباشرة، يوجّه الوكيل بهمسة ما يسمعها العميل، أو يستلم المكالمة بنفسه بأي لحظة. المدير يقدر يوقف الوكيل، يكمل هو، وبعدها يرجع المكالمة. هذي مو ميزة شائعة — أغلب المنصات ما تعطيك إياها أصلاً.",
        },
        {
        ...
        },
        {
          ...
          body: "الوكيل يعرف أوقات دوامك. إذا اتصل العميل والدوام مقفل والموضوع يحتاج إنسان، ما يقول له «حاول بكرة» — يسجل طلب اتصال بتفاصيله ووقته المفضل، ويوعده إن أحد من فريقك يرجع له. الطلب يظهر لفريقك في اللوحة ثاني يوم.",
        },
      ],
    },
    after: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "موظفك يشوف سبب التصعيد، والنص الكامل للمحادثة، وملخصاً عربياً واضحاً، وتاريخ العميل معكم — كل هذا قدامه لحظة الاستلام، فما يحتاج يسأل العميل «ممكن تعيد؟».",
      },
      {
      ...
      },
      {
        ...
        a: "الوكيل يعرف أوقات دوامك: يخدم العميل في اللي يقدر عليه، وإذا احتاج الموضوع إنسان يسجل طلب اتصال ويوعد العميل برجعة من فريقك — وما في عميل يطيح بين الكراسي.",
      },
    ] as FaqItem[],
    ...
    pillars: {
      ...
      items: [
        ...
        },
        {
          ...
          body: "From the dashboard, your team follows calls as they happen: listen in live, coach the agent with a whisper the customer never hears, or take the call over at any moment. A manager can pause the AI, continue personally, then hand the call back. Most platforms simply don't offer this.",
        },
        {
