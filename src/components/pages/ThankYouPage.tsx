...
const t = {
  ar: {
    ...
    body: "وصلك تأكيد الموعد على إيميلك، ومعه رابط الاجتماع. إذا حاب تجهز شي قبل العرض: فكر في أكثر ثلاثة أسئلة يسألها عملاؤك بالتلفون — بنوريك كيف يجاوب عليها الوكيل.",
    home: "الرئيسية",
    how: "اقرأ كيف يشتغل",
  },
  en: {
    h1: "Booked — see you soon!",
    body: "A confirmation with the meeting link is in your inbox. If you'd like to prepare: think of the three questions your customers ask most on the phone — we'll show you how the agent answers them.",
    home: "Home",
