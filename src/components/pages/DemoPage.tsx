...
const t = {
  ar: {
    ...
    lead: "عرض مدته 30 دقيقة: نوريك المنصة حية، نسمعك الوكيل بلهجتك، ونجاوب على كل أسئلتك.",
    pricingNote: "وفي نفس العرض نقيّم احتياجك — حجم مكالماتك وقنواتك — ونعطيك عرض سعر واضحاً يناسب نشاطك.",
    expect: {
      ...
      items: [
        ...
        "نجاوب على أسئلة الأمان والبيانات و PDPL",
